  ...
  return (
    <div className="text-center space-y-4 animate-float-slow">
      ...
      <div className="space-y-1">
        <h1 className="text-2xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-white/80">{title}</h1>
        <p className="text-sm opacity-70 max-w-sm mx-auto leading-relaxed">{bioText}</p>
      </div>
    </div>
  );
};
