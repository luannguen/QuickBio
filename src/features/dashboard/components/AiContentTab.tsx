  ...
  return (
    <div className="space-y-6 animate-fade-in text-left">
      ...
      {userPlan !== 'pro' ? (
        ...
        <>
          <form onSubmit={onGenerateAIContent} className="glass-card p-6 rounded-2xl border border-white/5 space-y-6">
            {aiError && (
            ...
            <button 
              ...
              className="px-6 py-3 bg-gradient-to-r from-brand-orange to-brand-coral hover:from-brand-coral hover:to-brand-orange disabled:from-white/5 disabled:to-white/5 disabled:text-white/30 text-white text-xs font-bold rounded-xl shadow-md transition-all active:scale-95 flex items-center gap-2 touch-target min-h-[40px]"
            >
              {aiGenerating ? (
                <>
