...
export const LandingPageDesktop: React.FC<LandingPageDesktopProps> = ({
  isAuthenticated,
  loading,
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-[#080B11] text-white bg-[linear-gradient(to_right,rgba(255,255,255,0.015)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.015)_1px,transparent_1px)] bg-[size:40px_40px]">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-24 space-y-16">
        ...
        {/* Bento Grid Features */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl pt-16 mx-auto">
        ...
        <div className="w-full max-w-5xl pt-20 pb-8 text-center space-y-8 mx-auto">
          <div className="space-y-2">
        ...
        <div className="w-full max-w-5xl pt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mx-auto">
        ...
        <div className="w-full max-w-4xl pt-16 mx-auto">
        ...
        <div className="w-full max-w-4xl pt-16 mx-auto font-sans">
        ...
        <div className="w-full max-w-5xl pt-24 pb-12 text-center space-y-12 mx-auto">
        ...
        <div className="w-full max-w-4xl pt-20 pb-12 text-center space-y-12 mx-auto">
          <div className="space-y-4">
            ...
            {[
              ...
              <div key={idx} className="bg-[#0f1422]/40 rounded-2xl border border-white/5 overflow-hidden transition-all duration-300">
                <button
                  ...
                  className="w-full px-6 py-4 flex items-center justify-between text-white font-bold text-sm hover:bg-white/[0.02] transition-colors text-left"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`w-4 h-4 text-white/50 transition-transform duration-300 flex-shrink-0 ml-2 ${openFaq === idx ? 'transform rotate-180 text-brand-orange' : ''}`} />
                </button>
