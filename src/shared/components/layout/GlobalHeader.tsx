...
export const GlobalHeader: React.FC<GlobalHeaderProps> = ({
  ...
  return (
    <header className="relative z-50 max-w-7xl mx-auto px-4 lg:px-6 py-4 lg:py-6 flex justify-between items-center border-b lg:border-none border-border bg-background/80 lg:bg-transparent backdrop-blur-md lg:backdrop-blur-none">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 top-0 left-0 w-full h-[100dvh] bg-background/95 backdrop-blur-xl z-[90] flex flex-col pt-24 px-6 gap-4 lg:hidden animate-in fade-in slide-in-from-top-4 duration-300">
          {onNavigateToBlog && (
